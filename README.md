...
### [Naqsh PDF](https://naqsh.sulaiman-kh.sa)

A document reconstruction experiment focused on rethinking how PDFs can be rebuilt, structured, and reused.

**Focus:** PDF workflows, document structure, interface design.

---

### [Aljawad Co](https://www.aljawadco.sa/)

A modern web presence for a marketing company, built around clear positioning, service presentation, and a polished Arabic user experience.

**Focus:** Arabic UI, brand presentation, responsive landing pages, business websites.
...
Systems       APIs · Automation · Dashboards
```
...
[Website](https://sulaiman-kh.sa) · [LinkedIn](https://www.linkedin.com/in/smohmmedkh/)
